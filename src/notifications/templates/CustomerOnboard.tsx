...
export const CustomerOnboardEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Welcome to MicroBuilt — Your customer account is ready</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Congratulations! You've been successfully onboarded as a customer by
            one of our admins. Your account has been created and is ready to
            use.
          </Text>
          ...
          <Section style={credentialsContainer}>
            ...
            {phone && (
              <Section style={credentialRow}>
                <Text style={credentialLabel}>Phone Number:</Text>
                <Text style={credentialValue}>{phone}</Text>
              </Section>
            )}
          ...
          <Section style={securitySection}>
            ...
            <Text style={securityText}>
              ...
              strongly recommend updating it once you log in for enhanced
              security.
            </Text>
            <Text style={securityText}>
